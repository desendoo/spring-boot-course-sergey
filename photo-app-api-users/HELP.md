...
* The original package name 'com.appsdeveloperblog.photoapp.api.users.photo-app-api-users' is invalid and this project uses 'com.appsdeveloperblog.photoapp.api.users.photoappapiusers' instead.
